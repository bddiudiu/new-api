...
func RecordLogWithQuota(c *gin.Context) {
	...
	case model.LogTypeTopup,
		...
		model.LogTypeRefund,
		model.LogTypeLogin,
		model.LogTypeMeeting,
		model.LogTypeActive,
		model.LogTypeUnlock,
		model.LogTypeCheckin,
		model.LogTypeQuotaExpiry,
		model.LogTypeVoice:
	default:
	...
	if err := model.RecordLogWithQuota(req.UserId, req.LogType, req.Quota, req.Content, req.Other); err != nil {
		common.ApiError(c, err)
		return
	}
